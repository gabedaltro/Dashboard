...
<div class="html-main">
  <div class="container" id="button-top">
      <div class="row">
          <div class="col">
              <a href="#" data-toggle="modal" data-target="#exampleModal"><button type="button" aria-hidden="true" class="btn btn-light"><i class="fas fa-print" aria-hidden="true"></i></button> Imprimir</a>
          </div>
      </div>
      <div class="row">
